      ...
      <div class="flex-div">
        <flexbox justify="center" align="center">
          ...
          <flexbox-item class="flex-item" :span="0.2">
            <x-button
              style="color:#fff;background-color:#2eb1fd;"
              class="item-btn"
              @click.native="searchRecord"
            >搜索</x-button>
          </flexbox-item>
        </flexbox>
      </div>
        ...
        <ul v-if="dataList.length !== 0" class="noti-list">
          <li>
            <div>
              ...
              <span class="info-label">{{ '晚归时长：' + item.count +'小时'}}</span>
            </div>
          </li>
        </ul>
      </div>
...
import { GetLateList } from "@/service";
