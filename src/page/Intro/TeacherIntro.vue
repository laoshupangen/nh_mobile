  ...
  <div class="teacher-wrapper">
    ...
    <div class="intro-text">
      <ul class="text-wrapper">
        ...
        <li class="textarea">
          <div class="text-box">
            <p>asdfafsdfdasfsadfasdfadsfsadfasdfsdafasdfssdfsdfsdfsdfsdfsdafsadfasdfasdfsdafasdfsdafsdafasdfasdfsoifhasdfklgbnasdoiughodsaiugbhoadsnflkdshjfgoiasdnglkdshgoiadsnglkdsahjfldsanfflksdahnflkdsanflksdanfsdanflksdnflkasdnfdafsadfsdafasdfasdfasdfasdfasdfsdsd</p>
          </div>
        </li>
      </ul>
    </div>
    ...
    <div class="intro-honor">
      ...
      <!-- <grid v-if="honor.length !== 0" :cols="3" :show-lr-borders="false" :show-vertical-dividers="false">
        <grid-item class="honor-item" v-for="(item, i) in honor" :key="i"> -->
          <!-- `${GLOBAL.API_HOST}${item.F_Covers}` -->
          <!-- <img src="http://www.pptbz.com/pptpic/UploadFiles_6909/201203/2012031220134655.jpg" />
          <p class="honor-title">{{ item.F_Title }}</p>
        </grid-item> -->
      <!-- </grid>
      <p v-else>无</p> -->
...
<script>
import { getTeacherDetailInfo } from '@/service'
...
export default {
  ...
  methods: {
    getTeacherInfo() {
      ...
      getTeacherDetailInfo(id).then(data => {
